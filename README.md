...
Get the agent running locally in seconds.

**1. Set up the environment**
Install dependencies and configure your keys:
```bash
uv sync
...
Option A: CLI Mode
Ask a question, review the drafted research, and approve the final save:
